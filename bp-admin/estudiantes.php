        ...
        <section class="section">
            ...
            <div class="modal-dialog">
                ...
                <div class="modal-header ">
                    <h5 class="modal-title" id="staticBackdropLabel">Añadir nuevo estudiante</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                <form id="form_1388" class="appnitro"  method="post" action="functions/add-student.php">				
                <ul>
                    
                <li id="li_1">
                <label class="description" for="element_1">Nombre del estudiante</label>
                <div>
            ...
            <table>
                ...
                <?php
                    ...
                    <td>' . $row["EJEMPLAR"] . '</td>
                    <td>' . $row["UBICACION"] . '</td>
                    <td><a href="functions/edit-student.php?id=' . $row["ID"] . '">Editar</a><br><a href="functions/del-student?id=' . $row["ID"] . '">Eliminar</a></td>
                </tr>';}
                    };
                ?>
                </tbody>
