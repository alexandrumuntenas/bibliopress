...
<h2>Catálogo del '.$sname.'</h2>
        ...
        if ($lectorresultado->num_rows > 0) {
            ...
            while ($row = $resultado->fetch_assoc()) {
                echo '<tr>
                            <td data-label="Usuario"><br>' . $row["TITULO"] . '</td>
                            <td data-label="Nombre"><br>' . $row["AUTOR"] . '</td>
                            <td data-label="Apellidos"><br>' . $row["EJEMPLAR"] . '</td>
                            <td data-label="Clase o Grupo"><br>' . $row["EDITORIAL"] . '</td>
                        </tr>';
            }
            echo '
                        </tbody>
