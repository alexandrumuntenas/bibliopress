...
<body id="main_body" >
	...
	<div id="form_container">
		...
		<form id="form_4248" class="appnitro"  method="post" action="step2.php">
			...
			<h3><h3>Configuración de la Base de Datos</h3></h3>
			<p></p>
		</li>		<li id="li_1" >
		...
		<div>
			...
			<h3><h3>Configuración del usuario administrativo (Luego podrás asignar a más usuarios)</h3></h3>
			<p></p>
		</li>		<li id="li_7" >
		...
		<li class="section_break">
			<h3><h3>Configuración del Cargador de Abies</h3></h3>
			<p></p>
		</li>
		<li id="li_12" >
		...
		<div>
			...
			<h3><h3>Últimas configuraciones</h3></h3>
			<p></p>
		</li>		<li id="li_12" >
