                ...
                ?>
                        ...
                        <div class="lectores">
                            <div class="table-responsive">
                                ...
                                ';
                                                if ($status == 0) {
                                                    echo '<td><br><a style="color:green;" href="?estado=' . $status . '&solicitar&accion=aprobar&id=' . $solicitudrow["ID"] . '">Aprobar</a>         <a style="color:red; margin-left:10px;" href="?estado=' . $status . '&solicitar&accion=rechazar&id=' . $solicitudrow["ID"] . '">Rechazar</a></td>';
                                                }
                                                echo '</tr>';
                                            }
                                        } else { ?>
